...
const SENSITIVE_SETTINGS_KEYS = [
  'imageApiKey', 'textAiKey', 'smtpPass', 'brevoApiKey', 'serperApiKey',
  'cloudinaryApiKey', 'cloudinaryApiSecret', 'imagekitPrivateKey', 'uploadcareSecretKey', 'imgbbApiKey', 'customUploadApiKey',
];

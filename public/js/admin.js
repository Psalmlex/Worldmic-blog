...
function renderAdminLayout(activeLink = '') {
  ...
  if (role === 'admin') {
    ...
    nav.push({ href: '/admin-autopublisher.html', icon: 'M12 2a1 1 0 0 1 1 1v2.06A8.01 8.01 0 0 1 19.94 11H22a1 1 0 1 1 0 2h-2.06A8.01 8.01 0 0 1 13 19.94V22a1 1 0 1 1-2 0v-2.06A8.01 8.01 0 0 1 4.06 13H2a1 1 0 1 1 0-2h2.06A8.01 8.01 0 0 1 11 4.06V2a1 1 0 0 1 1-1zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 2.5 1.2 2.3 2.3.3-1.7 1.6.4 2.3-2.2-1.1-2.2 1.1.4-2.3-1.7-1.6 2.3-.3z', label: 'AI Auto Publisher' });
    nav.push({ href: '/admin-affiliate.html', icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm2.07-7.75-.9.92C13.45 11.9 13 12.5 13 14h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z', label: 'Affiliate Publisher' });
